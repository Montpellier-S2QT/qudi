...
class Cornerstone(Base, GratingSpectrometerInterface):
    ...
    def on_activate(self):
        ...
        try:
            ...
            self.log.error('Error during visa connection with Cornerstone spectrometer, check the connections.')
            return
