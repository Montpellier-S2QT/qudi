...
"""
This file contains the Qudi hardware module for AWG5200 Series from Tektronix.
...
class AWG5200(Base, PulserInterface):
    """ A hardware module for the Tektronix AWG5200 series for generating
        waveforms and sequences thereof.

    Example config for copy-paste:

    pulser_awg5200:
        module.Class: 'awg.tektronix_awg5200.AWG5200'
    ...
    def get_constraints(self):
        ...
        constraints.sample_rate.min = 298
        constraints.sample_rate.step = 10 # arbitrary
        
        if '25' in self.__installed_options:
            constraints.sample_rate.max = 2.5e9           
            constraints.sample_rate.default = 2.5e9
        elif '50' in self.__installed_options:
        ...
        # Values checked, step arbitrary
        constraints.d_ch_low.min = -0.5
        constraints.d_ch_low.max = 1.55
        constraints.d_ch_low.step = 0.1e-3
        constraints.d_ch_low.default = 0.0

        # Values checked, step arbitrary
        constraints.d_ch_high.min = -0.3
    ...
    def get_interleave(self):
        ...
        Unused for pulse generator hardware other than an AWG. No interleave on this model.
        """
        return False
    ...
    def set_interleave(self, state=False):
        ...
        """
        if state:
            self.log.warning('Interleave mode not available for the AWG5200 Series!\n'
    ...
    def _create_xml_header(self, number_of_samples, markers_active):
        ...
        sub_elem.text = datetime.datetime.now().isoformat()
